...
/*
 * The drawing context is accessed by getContext() and the hud
 * accessed by getHud(). Further, the draw() methods should ask this to
 * draw. This will order the things to be drawn by colour, optimising the
 * hell out of it.
 */
public class DrawingManager {
	 ...
	 * buffering).
	 */
	public DrawingManager(boolean doubleBuffered, int x, int y, int w, int h) {
